...
> библиотек просто завершается; если необходимо выполнить пересборку, сделать
clean up в папке Externals.Vcpkg\Vcpkg.
...
- [15.12.2024] Сборка с использованием Android NDK r23c (которая идет в
комплекте с Visual Studio 2022) завершается с ошибкой сборки boost-locale из-за
libiconv - использовать **android-ndk-r26d**.
